...
def upgrade():
    ...
    op.add_column('users', sa.Column('identity_pub_ed25519', sa.LargeBinary(32), nullable=True))
    op.add_column('users', sa.Column('identity_pub_x25519', sa.LargeBinary(32), nullable=True))

    # Add key backup fields to users
    op.add_column('users', sa.Column('encrypted_backup', sa.LargeBinary(), nullable=True))
    op.add_column('users', sa.Column('backup_version', sa.Integer(), nullable=False, server_default='1'))

    # Add E2EE fields to messages
    op.add_column('messages', sa.Column('encrypted_blob', sa.LargeBinary(), nullable=True))
    ...
    op.add_column('messages', sa.Column('is_encrypted', sa.Boolean(), nullable=False, server_default='false'))
